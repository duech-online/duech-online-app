      ...
      <div className="space-y-6">
        <div className="rounded-lg bg-white p-8 shadow-md">
          ...
          <p className="mb-4 text-gray-700">
            ...
            de uso del español de Chile (DUECh), una obra fundamental para la comprensión y estudio
            del español chileno.
          </p>
        ...
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-8">
          ...
          <p className="mt-4 text-gray-700">
            El contenido lexicográfico proviene del Diccionario de uso del español de Chile
            (DUECh).
          </p>
        </div>
      </div>
