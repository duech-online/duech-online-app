...
export function SearchPage({
    ...
    const urlCategories = useMemo(() => parseListParam(searchParams.get('categories')), [searchParams]);
    ...
    const initialFilters = useMemo(
        () => ({ categories: urlCategories, styles: urlStyles, origins: urlOrigins, letters: urlLetters }),
    ...
    return (
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            {/* Header */}
            <div className={`mb-${editorMode ? '3' : '10'} ${editorMode ? 'flex items-center justify-between' : ''}`}>
            ...
            <div>
                {isLoading ? (
                    ...
                    <div className="rounded-lg bg-white p-12 text-center shadow">
                        ...
                        <p className="text-gray-600">'Usa la búsqueda avanzada arriba para encontrar palabras por categorías, estilos, origen o letra.
                        </p>
                    </div>
                )}
            </div>
